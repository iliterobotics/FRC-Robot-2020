...
//            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, 1.0);
//
//        } else if (db.operatorinput.isSet(ELogitech310.Y_BTN)){
//            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, 0);
//        }
//        else {
//            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, 0.5);
//        }
//        if (db.operatorinput.isSet(InputMap.OPERATOR.LOCK_TARGET)) {
//            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, EShooterSystemData.SERVO_DISTANCE_BASED_ANGLE);
//        } else {
//            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, 0);
//        }
        if (db.operatorinput.isSet(ELogitech310.A_BTN)) {
            db.flywheel.set(EShooterSystemData.TARGET_POTENTIOMETER_POSITION, 1);
